    ...
    <main>
        ...
        <article class="article-3">
            <figure class="figure-fade">
                <blockquote>
                    <p>
                        Nó giúp tôi hoạt động chính xác và tự tin như tôi cần để chúng tôi có thể giành chiến thắng. Tôi thường nghĩ rằng không dây là quá chậm để chơi game, nhưng giờ tôi đang đứng trên sàn đấu thế giới và hoàn toàn tự tin về hiệu suất của chuột không dây LIGHTSPEED từ Logitech G.
                    </p>
                </blockquote>
                <br>
                <div>
