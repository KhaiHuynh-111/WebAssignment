    ...
    <article class="article-2" id="mouse">
        ...
        <div class="container">
            ...
            <div class="main-container">
                ...
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='mouse' and name LIKE 'G%'");
            ...
            <div class="main-container">
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='mouse' and name LIKE 'PRO%'");
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row["name"];
                    $about = $row["about"];
                    $price = $row["price"];
    ...
    <article class="article-2" id="keyboard">
        ...
        <div class="container">
            ...
            <div class="main-container">
                ...
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='keyboard' and name LIKE 'G%'");
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row["name"];
                    $about = $row["about"];
                    $price = $row["price"];
            ...
            <div class="main-container">
                ...
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='keyboard' and name LIKE 'PRO%'");
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row["name"];
                    $about = $row["about"];
                    $price = $row["price"];
    ...
    <article class="article-2" id="headphone">
        ...
        <div class="container">
            ...
            <div class="main-container">
                ...
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='headphone' and name LIKE 'G%'");
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row["name"];
                    $about = $row["about"];
                    $price = $row["price"];
            ...
            <div class="main-container">
                ...
                <?php
                $result = mysqli_query($db_con, "SELECT * FROM products WHERE type='headphone' and name LIKE 'PRO%'");
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row["name"];
                    $about = $row["about"];
                    $price = $row["price"];
