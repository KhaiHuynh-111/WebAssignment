...
INSERT INTO `products` (`id`, `name`, `imgURL`, `status`, `quantity`, `unit`, `price`, `type`, `about`) 
VALUES
...
--
-- Ghi lại link hinh cua chi tiet san pham
--
...
INSERT INTO `products_img` (`proc_id`, `img_link`) 
VALUES
...
--
-- Dang do du lieu cho bang `products_img`
--

INSERT INTO `products_spec` (`proc_id`, `spec1_key`,`spec1_value`,`spec2_key`,`spec2_value`,`spec3_key`,`spec3_value`) 
VALUES
